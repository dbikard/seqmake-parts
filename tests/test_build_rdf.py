...
CAT = rdflib.Namespace("https://w3id.org/seqmake/parts/ns#")
PART = rdflib.Namespace("https://w3id.org/seqmake/parts/part/")
...
def test_regulation_is_modeled_both_ways():
    ...
    PREFIX part: <https://w3id.org/seqmake/parts/part/>
    ASK {
