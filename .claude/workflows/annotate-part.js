...
const ELEMENT_GUIDES = {
  promoter: {
    scout: 'EVERY applicable cis element — the -35 box, -10 box, transcription start site (+1), any operator / repressor or activator binding site, and any RBS / Shine-Dalgarno',
    lenses: [
    ...
    locate: 'Use GenBank feature types: regulatory for -35/-10 (element in the label + a regulatory_class), protein_bind for operators, misc_feature for +1/TSS, RBS for ribosome binding sites.',
  },
  origin: {
